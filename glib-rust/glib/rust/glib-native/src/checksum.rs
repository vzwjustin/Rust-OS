...
mod tests {
    ...
    fn md5_quick_fox() {
        assert_eq!(
            compute_checksum_for_string(ChecksumType::Md5, "The quick brown fox jumps over the lazy dog"),
    ...
    fn sha1_quick_fox() {
        assert_eq!(
            compute_checksum_for_string(ChecksumType::Sha1, "The quick brown fox jumps over the lazy dog"),
    ...
    fn sha256_quick_fox() {
        assert_eq!(
            compute_checksum_for_string(ChecksumType::Sha256, "The quick brown fox jumps over the lazy dog"),
