...
/// Initialize graphics from a raw framebuffer pointer (e.g. from bootloader)
pub fn init_graphics_from_raw(
    buffer_ptr: *mut u8,
    width: usize,
    height: usize,
    ...
    crate::graphics::framebuffer::init_from_raw(buffer_ptr, width, height, pixel_format)?;

    graphics.framebuffer_info = Some(FramebufferInfo::new(
        width,
        height,
        pixel_format,
        buffer_ptr as usize,
...
static DEFAULT_FONT_DATA: [u8; 256 * 8] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Character 0x21 (!)
    0x18, 0x18, 0x18, 0x18, 0x00, 0x00, 0x18, 0x00, // Character 0x22 (")
    0x66, 0x66, 0x66, 0x00, 0x00, 0x00, 0x00, 0x00, // Character 0x23 (#)
    0x66, 0x66, 0xFF, 0x66, 0xFF, 0x66, 0x66, 0x00, // Character 0x24 ($)
    0x18, 0x3E, 0x60, 0x3C, 0x06, 0x7C, 0x18, 0x00, // Character 0x25 (%)
    0x62, 0x66, 0x0C, 0x18, 0x30, 0x66, 0x46, 0x00, // Character 0x26 (&)
    0x3C, 0x66, 0x3C, 0x38, 0x67, 0x66, 0x3F, 0x00, // Character 0x27 (')
    0x06, 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, // Character 0x28 (()
    0x0C, 0x18, 0x30, 0x30, 0x30, 0x18, 0x0C, 0x00, // Character 0x29 ())
    0x30, 0x18, 0x0C, 0x0C, 0x0C, 0x18, 0x30, 0x00, // Character 0x2A (*)
    0x00, 0x66, 0x3C, 0xFF, 0x3C, 0x66, 0x00, 0x00, // Character 0x2B (+)
    0x00, 0x18, 0x18, 0x7E, 0x18, 0x18, 0x00, 0x00, // Character 0x2C (,)
    0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x30, // Character 0x2D (-)
    0x00, 0x00, 0x00, 0x7E, 0x00, 0x00, 0x00, 0x00, // Character 0x2E (.)
    0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x00, // Character 0x2F (/)
    0x00, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x00,
    // Digits 0-9
    // Character 0x30 (0)
    0x3C, 0x66, 0x6E, 0x76, 0x66, 0x66, 0x3C, 0x00, // Character 0x31 (1)
    0x18, 0x18, 0x38, 0x18, 0x18, 0x18, 0x7E, 0x00, // Character 0x32 (2)
    0x3C, 0x66, 0x06, 0x0C, 0x30, 0x60, 0x7E, 0x00, // Character 0x33 (3)
    0x3C, 0x66, 0x06, 0x1C, 0x06, 0x66, 0x3C, 0x00, // Character 0x34 (4)
    0x06, 0x0E, 0x1E, 0x66, 0x7F, 0x06, 0x06, 0x00, // Character 0x35 (5)
    0x7E, 0x60, 0x7C, 0x06, 0x06, 0x66, 0x3C, 0x00, // Character 0x36 (6)
    0x3C, 0x66, 0x60, 0x7C, 0x66, 0x66, 0x3C, 0x00, // Character 0x37 (7)
    0x7E, 0x66, 0x0C, 0x18, 0x18, 0x18, 0x18, 0x00, // Character 0x38 (8)
    0x3C, 0x66, 0x66, 0x3C, 0x66, 0x66, 0x3C, 0x00, // Character 0x39 (9)
    0x3C, 0x66, 0x66, 0x3E, 0x06, 0x66, 0x3C, 0x00, // Character 0x3A (:)
    0x00, 0x00, 0x18, 0x00, 0x00, 0x18, 0x00, 0x00, // Character 0x3B (;)
    0x00, 0x00, 0x18, 0x00, 0x00, 0x18, 0x18, 0x30, // Character 0x3C (<)
    0x0E, 0x18, 0x30, 0x60, 0x30, 0x18, 0x0E, 0x00, // Character 0x3D (=)
    0x00, 0x00, 0x7E, 0x00, 0x7E, 0x00, 0x00, 0x00, // Character 0x3E (>)
    0x70, 0x18, 0x0C, 0x06, 0x0C, 0x18, 0x70, 0x00, // Character 0x3F (?)
    0x3C, 0x66, 0x06, 0x0C, 0x18, 0x00, 0x18, 0x00, // Character 0x40 (@)
    0x3C, 0x66, 0x6E, 0x6E, 0x60, 0x62, 0x3C, 0x00,
    // Letters A-Z
    // Character 0x41 (A)
    0x18, 0x3C, 0x66, 0x7E, 0x66, 0x66, 0x66, 0x00, // Character 0x42 (B)
    0x7C, 0x66, 0x66, 0x7C, 0x66, 0x66, 0x7C, 0x00, // Character 0x43 (C)
    0x3C, 0x66, 0x60, 0x60, 0x60, 0x66, 0x3C, 0x00, // Character 0x44 (D)
    0x78, 0x6C, 0x66, 0x66, 0x66, 0x6C, 0x78, 0x00, // Character 0x45 (E)
    0x7E, 0x60, 0x60, 0x78, 0x60, 0x60, 0x7E, 0x00, // Character 0x46 (F)
    0x7E, 0x60, 0x60, 0x78, 0x60, 0x60, 0x60, 0x00, // Character 0x47 (G)
    0x3C, 0x66, 0x60, 0x6E, 0x66, 0x66, 0x3C, 0x00, // Character 0x48 (H)
    0x66, 0x66, 0x66, 0x7E, 0x66, 0x66, 0x66, 0x00, // Character 0x49 (I)
    0x3C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, // Character 0x4A (J)
    0x1E, 0x0C, 0x0C, 0x0C, 0x0C, 0x6C, 0x38, 0x00, // Character 0x4B (K)
    0x66, 0x6C, 0x78, 0x70, 0x78, 0x6C, 0x66, 0x00, // Character 0x4C (L)
    0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x7E, 0x00, // Character 0x4D (M)
    0x63, 0x77, 0x7F, 0x6B, 0x63, 0x63, 0x63, 0x00, // Character 0x4E (N)
    0x66, 0x76, 0x7E, 0x7E, 0x6E, 0x66, 0x66, 0x00, // Character 0x4F (O)
    0x3C, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, // Character 0x50 (P)
    0x7C, 0x66, 0x66, 0x7C, 0x60, 0x60, 0x60, 0x00, // Character 0x51 (Q)
    0x3C, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x0E, 0x00, // Character 0x52 (R)
    0x7C, 0x66, 0x66, 0x7C, 0x78, 0x6C, 0x66, 0x00, // Character 0x53 (S)
    0x3C, 0x66, 0x60, 0x3C, 0x06, 0x66, 0x3C, 0x00, // Character 0x54 (T)
    0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00, // Character 0x55 (U)
    0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, // Character 0x56 (V)
    0x66, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x00, // Character 0x57 (W)
    0x63, 0x63, 0x63, 0x6B, 0x7F, 0x77, 0x63, 0x00, // Character 0x58 (X)
    0x66, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0x66, 0x00, // Character 0x59 (Y)
    0x66, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x18, 0x00, // Character 0x5A (Z)
    0x7E, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x7E, 0x00, // Symbols
    0x0E, 0x18, 0x30, 0x30, 0x30, 0x18, 0x0E, 0x00, // 0x5B [
    0x18, 0x0C, 0x06, 0x06, 0x06, 0x0C, 0x18, 0x00, // 0x5C \
    0x70, 0x18, 0x0C, 0x0C, 0x0C, 0x18, 0x70, 0x00, // 0x5D ]
    0x08, 0x2A, 0x1C, 0x1C, 0x1C, 0x2A, 0x08, 0x00, // 0x5E ^
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7E, 0x00, // 0x5F _
    0x0C, 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x60 `
    // Lowercase letters (proper 8x8 glyphs)
    ...
    0x00, 0x06, 0x00, 0x06, 0x06, 0x06, 0x66, 0x3C, // j
    ...
    0x00, 0x00, 0x00, 0x36, 0x6C, 0x00, 0x00, 0x00, // 0x7E ~
...
mod tests {
    ...
    fn test_graphics_status_display() {
        ...
        assert_eq!(
            format!("{}", GraphicsStatus::Uninitialized),
            "Uninitialized"
        );
