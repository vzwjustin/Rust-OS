...
"x86_64\-linux\-thread\-multi-6\.12\.54\-0\-lts" or
	die "Errno architecture (x86_64\-linux\-thread\-multi-6\.12\.54\-0\-lts) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
